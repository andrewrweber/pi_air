...
class TestAPIRoutes:
    ...
    def test_air_quality_latest_api(self, client, sample_air_quality_data):
        ...
        # Insert test data
        with patch.object(database, 'get_latest_reading') as mock_get:
    ...
    def test_air_quality_worst_24h_api(self, client, sample_air_quality_data):
        ...
        with patch.object(database, 'get_readings_last_24h') as mock_get:
    ...
    def test_air_quality_history_api_default(self, client):
        ...
        with patch.object(database, 'get_interval_averages') as mock_get:
            mock_averages = [
                {
            ...
            mock_get.assert_called_with(hours=24, interval_minutes=15)
    ...
    def test_temperature_history_api(self, client, mock_temperature_command):
        ...
        with patch.object(database, 'get_temperature_history_optimized') as mock_db_temp:
    ...
    def test_system_history_api(self, client):
        ...
        with patch.object(database, 'get_db_connection') as mock_conn:
            # Mock database connection and results
            mock_cursor = Mock()
            mock_cursor.fetchall.return_value = [
                ('2023-01-01 10:00:00', 25.0, 50.0, 75.0, 55.0, 10),
                ('2023-01-01 11:00:00', 30.0, 55.0, 76.0, 57.0, 12),
            ]
            mock_cursor.fetchone.return_value = (25.0, 50.0, 75.0, 55.0, '2023-01-01 12:00:00')
...
class TestAPIIntegration:
    ...
    def test_complete_air_quality_workflow(self, client, sample_air_quality_data):
        ...
        with patch.object(database, 'insert_air_quality_reading'):
            database.insert_air_quality_reading(**sample_air_quality_data)
        
        # Mock the retrieval
        with patch.object(database, 'get_latest_reading') as mock_latest, \
             patch.object(database, 'get_readings_last_24h') as mock_24h:
